let hnam = document.createElement("nav");
hnam.innerHTML=`<div class="container-fluid">
<h1 class=" text-center pt-2 pb-2" id="title" style="color: white">DOM MANIPULATION FORM</h1></div>`;
document.body.append(hnam);

let hnam1 = document.createElement("hnam1");
hnam1.innerHTML=`<div class="containe">
<h2><p id="description" class="text-center">User Enter Information</p></h2></div>`;
document.body.append(hnam1);
...
Column1.setAttribute("class","container col-lg-4 mt-4");
...
f_div6.innerHTML= `  <label class="form-label">Choice of foods <span>(*must choose at least 2 food type)</span></label>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="North Indian"  id="North Indian"  name="option"/>
  <label class="form-check-label" for="North Indian">North Indian</label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="South Indian"  id="South Indian"  name="option" />
  <label class="form-check-label" for="South Indian">South Indian</label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Chinese"  id="Chinese"  name="option" />
  <label class="form-check-label" for="Chinese">Chinese</label>
</div>
<div class="form-check">
  <input  class="form-check-input"  type="checkbox"  value="Japanese"  id="Japanese"  name="option" />
  <label class="form-check-label" for="Japanese">Japanese</label>
</div>
<div class="form-check">
    <input  class="form-check-input"  type="checkbox"  value="Sea food"  id="Sea food"  name="option" />
    <label class="form-check-label" for="Sea food">Sea food</label>
</div>`;
form1.append(f_div6);
...
Column2.setAttribute("class","container col-lg- mt-4");
const R_div1 = document.createElement("div");
R_div1.setAttribute("class","mt-5");
R_div1.innerHTML=`<h1 class="text-center pt-1 pb-2"  id="title1" style="color: white">USER TABLE DATABASE</h1>`;
...
document.getElementById(
      ...
      <td> ${document.getElementById("country").value}</td></tr> `;
